...
3. Resolver module that validates on-chain records and returns signed proofs to clients.
4. Browser plugin or local gateway that intercepts DNS resolution to validate against proofs.
5. Benchmarking record latency. Throughput under load, cache efficiency.
